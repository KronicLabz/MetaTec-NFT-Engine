...
import { CardanoMetadata, CardanoNFTData, CardanoProperties, EthNftMetaData, PhoenixNftMetaData, ItemRarityFolder, Layer, NftAttribute, NftDirectory, NftItem, SolNftMetaData } from '../shared/models/NFTModels';
...
export class HomeComponent implements OnInit {
  ...
  nftDescription: FormControl = new FormControl('{name} - Generated by KronicLabz NFT Art Engine.', [])
  ...
  createMetadataFile(selectedNftFolderItems: NftItem[], fileName: string){
    ...
    let metadata: EthNftMetaData | PhoenixNftMetaData | SolNftMetaData | CardanoNFTData;
      ...
      case 'solana': {
        metadata =  {
          ...
          collection: {
            ...
            family: "KronicLabz NFT Art Engine",
          },
          properties: {
            hash: this.getNFTImageItemsHash(selectedNftFolderItems)
          }
